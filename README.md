...
- Commander Thum-B is a Coming Soon arcade-defense game.
...
The root route is studio-first. Global navigation is Home, Games, Play Palace, News, and About 4OH. The Palace table-name control exists only in palace-play.html. Support remains in the footer and direct route.

Artwork derivatives are built by scripts/process-portfolio-art.py. Founder source boards remain untouched. See [Portfolio art provenance](docs/PORTFOLIO-ART-PROVENANCE.md).
...
- [Commander Thum-B website](COMMANDER_THUMB_WEBSITE.md)
