...
Each record needs a stable slug, accurate ISO date, category, optional gameKey, tags, image, meaningful alt text, featured state, and body sections. The company newsroom covers all seven games. Filters expose Company, Palace, Bobby, Evil Doom, Commander Thum-B, and Development views.
