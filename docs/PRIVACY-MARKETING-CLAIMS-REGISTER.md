...
| Local-first where practical | Qualified principle | Product design | Palace state remains in the browser; other lessons use page memory; People Lens is explicitly qualified | Manifest privacy profiles | QUALIFIED |
...
| Palace browser game keeps one game on device | Verifiable claim | Palace web edition | Versioned localStorage; no account or request endpoint | Palace save/resume and network tests | VERIFIED |
