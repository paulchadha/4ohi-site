...
Four of Hearts Interactive is the parent company; 4OH is the compact mark; every named title is one product. The generated static site reads a single ten-product manifest.

Homepage sequence: studio hero → Palace feature → compact four-card rail → “4-OHHHH. NOW YOU GET IT.” studio bridge → six Original Worlds → three Card Table titles → Workbench news → concise founder/About statement → footer.
