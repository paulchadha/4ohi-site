...
write("privacy.html", page({
  ...
  content: `${pageHero("California privacy", "Privacy without the runaround.", "Optional cookies stay off. We do not sell personal information, share it for cross-context behavioral advertising, or build visitor profiles.", '<button class="button" type="button" data-open-privacy>Open Your Privacy Choices</button>')}<section class="section navy"><div class="shell"><div class="privacy-dashboard" aria-label="Website privacy status"><div class="privacy-row"><div><b>Strictly necessary</b><p>Ordinary site delivery plus one opt-out cookie only when you ask us to remember your choice.</p></div><span>Limited</span></div><div class="privacy-row"><div><b>Analytics</b><p>No analytics scripts or visitor measurement.</p></div><span>Off</span></div><div class="privacy-row"><div><b>Advertising</b><p>No ads, pixels, or targeted advertising.</p></div><span>Off</span></div><div class="privacy-row"><div><b>Sale or sharing</b><p>No sale of personal information or sharing for cross-context behavioral advertising.</p></div><span>Not performed</span></div><div class="privacy-row"><div><b>Global Privacy Control</b><p>A browser GPC signal is treated as an opt-out request.</p></div><span data-gpc-summary>Recognized</span></div><div class="privacy-row"><div><b>Game progress</b><p>Website previews use page memory and reset on refresh.</p></div><span>Not stored</span></div></div></div></section><section class="section" id="california-notice"><div class="narrow prose legal-policy"><p class="policy-meta"><strong>California Privacy Policy and Notice at Collection</strong><br>Effective and last updated: August 30, 2026</p><p class="notice"><strong>Legal-review status:</strong> This is a detailed, lawyer-ready operational draft based on the website’s current data practices. It was not written or approved by an attorney and is not legal advice. Qualified California privacy counsel should review it before the company represents it as attorney-approved.</p>
