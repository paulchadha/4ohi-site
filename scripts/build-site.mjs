...
const gameNav = (game, section) => {
  const links = game === "palace"
    ...
    : [["overview", "thumb-command.html", "Overview"], ["mission", "thumb-command.html#mission", "Mission"], ["gameplay", "thumb-command.html#gameplay", "Gameplay"], ["cities", "thumb-command.html#cities", "World Tour"], ["gallery", "thumb-command.html#gallery", "Gallery"], ["news", "news.html?tag=thumb-command", "News"]];
...
write("thumb-command.html", thumbCommandPage({ page, company, siteUrl, gameNav }));
