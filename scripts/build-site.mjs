...
const globalDialogs = () => `
  <dialog class="site-dialog" data-settings-dialog aria-labelledby="settings-title">
    <form method="dialog"><button class="dialog-close" value="cancel" aria-label="Close settings">×</button>
      ...
      <p>Language and game preferences are not stored. A privacy-choice cookie is used only if you ask us to remember that optional cookies must stay off.</p>
    </form>
  </dialog>
...
const footer = () => `<footer class="site-footer">
  <div class="shell"><div class="footer-grid footer-grid-editorial">
    <div class="footer-brand"><div class="footer-title"><span aria-hidden="true">♥</span><strong>${company}</strong></div><p class="footer-copy">Independent software from South Dakota.</p><p class="footer-promise">We sell software. Not people.</p><a href="mailto:support@4ohi.com">support@4ohi.com</a><div class="social-slot" data-social-slot aria-label="Official social profiles"></div></div>
    <nav class="footer-group" aria-label="Original games"><h2>Original Games</h2><a href="games/thumb-command/">Thumb Command</a><a href="bobby-the-breadasaurus.html">Bobby the Breadasaurus</a><a href="evil-doom-adventures.html">Evil Doom Girl Adventures</a><a href="heartstack-unicorn-blast.html">HeartStack Unicorn Blast</a><a href="princess-land-adventures.html">Princess Land</a><a href="unicorn-land-adventures.html">Unicorn Land</a></nav>
    <nav class="footer-group" aria-label="Card table"><h2>Card Table</h2><a href="palace.html">Palace</a><a href="hearts-play.html">Hearts</a><a href="spades-play.html">Spades</a><a href="euchre-play.html">Euchre</a><a href="solitaire.html">Solitaire</a><a href="war.html">War</a></nav>
    ...
    <nav class="footer-group" aria-label="Company"><h2>Company</h2><a href="about.html">About</a><a href="news.html">News</a><a href="support.html">Support</a><a href="contact.html">Contact</a></nav>
...
write("about.html", page({ title: "About Four of Hearts Interactive | Independent Software Studio", description: "Four of Hearts Interactive is an independent South Dakota company building games, useful applications, and custom software.", path: "/about.html", current: "about", bodyClass: "about-page", content: `<section class="studio-bridge about-studio-hero"><div class="shell bridge-grid"><h1>Four of Hearts<br><em>Interactive.</em></h1><div><p class="eyebrow">Independent software from South Dakota.</p><p class="lede">Games, useful applications, and custom software—built by a small studio that answers directly for the work.</p></div></div></section><section class="about-editorial"><div class="shell about-editorial-grid"><div><p class="eyebrow">What we make</p><h2>Products with a reason to exist.</h2><p>Original titles, familiar card tables, practical applications, and fast custom builds for clients with a clear problem to solve.</p></div><div><p class="eyebrow">How we work</p><h2>Make it. Test it. Improve it.</h2><p>Code quality, physical testing, documentation, direct feedback, and iteration. Small teams move quickly when decision-makers can talk to the people making the product.</p></div><div><p class="eyebrow">How we make money</p><h2>Customers pay for software.</h2><p>Good products cost money to build and maintain. We would rather charge clearly for useful work than let advertisers pay us to study the people using it.</p><a class="text-link" href="privacy.html#how-we-make-money">Read the business model →</a></div><div id="the-name"><p class="eyebrow">Why Four of Hearts</p><h2>Four kids. A house full of games.</h2><p>The name came first. The company grew around a simple idea: make products we want to use, titles we want to play, and treat the people using both with respect.</p></div><div><p class="eyebrow">Privacy</p><h2>Part of the architecture.</h2><p>We collect as little information as a product actually needs and keep it on-device whenever practical. Each released product will explain its own behavior plainly.</p><a class="text-link" href="privacy.html">Read our privacy approach →</a></div></div></section><section class="studio-services" aria-labelledby="about-services-title"><div class="shell services-grid"><div><p class="eyebrow">Creative technology studio</p><h2 id="about-services-title">Strong idea.<br><em>Working software.</em></h2></div><div class="services-copy"><p class="lede">Need a custom application or interactive prototype? We can move from a useful problem to working software quickly.</p><p>Clear scope. Direct communication. No inflated process theatre.</p><div class="actions"><a class="button" href="mailto:support@4ohi.com?subject=Custom%20application%20project">Talk about a project</a></div></div></div></section>` }));write("support.html", page({
